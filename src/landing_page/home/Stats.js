       ...
       <div className='container p-3'>
        <div className='row p-5'>
            <div className='col-6 p-5'>
                ...
                <p className='text-muted'>No gimmicks, spam, "gamification", or annoying push notification. High quality apps that you see use at your pace, the way you like.</p>
                ...
                <p className='text-muted'>With initiatives like Nudge and Kill Switch, we don't just facilite transaction, but actively help you do better with your money.</p>  
            </div>
            <div className='col-6 p-5'>
