    ...
    <div className="conatiner">
      ...
      <div className="row p-5 mt-5 border-top text-muted fs-6" style={{lineHeight:"1.8", fontSize:"1.2em"}}>
        ...
        <div className="col-6 p-5">
         ...
         <p>In addition, we run a number of popular open or lee community initiatives to empower retail traders and investors.</p>

        <p>
           <a href=""  style={{textDecoration:"none"}} >Rainmatters</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.
           </p>
